import certificate from "./../../assets/ssb-2026.pdf";

const Summits = () => {
    const summits = [
        {
            title: "South Summit Brazil 2026",
            year: "2026",
            icon: "account_tree",
            file: certificate
        }
    ...
    return (
        <section id="summits" className="mb-32 md:mb-64">
            <h2 className="font-display text-4xl md:text-6xl font-black uppercase tracking-tighter mb-10 md:mb-16">Summits Participated In</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                {summits.map((pub, index) => (
                    <a
                        key={index}
                        href={pub.file}
                        target="_blank"
